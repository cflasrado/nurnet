...
FlipBook.prototype = {
	...
	,removeBookmark: function(pageNum) {
		...
		while(_g1 < _g) {
			var i1 = _g1++;
			haxe.Log.trace(RunTime.book.bookmarks[i1].pageNum,{ fileName : "FlipBook.hx", lineNumber : 2129, className : "FlipBook", methodName : "removeBookmark"});
	...
	,onTouchMove: function(e) {
		...
		if(this.zoomStatus == core.ZoomStatus.zoomed && this.startMoveGesture) {
			...
			haxe.Log.trace(this.zoom.style.cssText,{ fileName : "FlipBook.hx", lineNumber : 1581, className : "FlipBook", methodName : "onTouchMove"});
	...
	,pointDown: function(e) {
		var obj = e;
		haxe.Log.trace("pointDown",{ fileName : "FlipBook.hx", lineNumber : 440, className : "FlipBook", methodName : "pointDown"});
...
core.HtmlHelper.toPopupImageHtml = function(item,success) {
	...
	if(item.popupWidth != null && item.popupHeight != null) {
		...
		s += "</div>";
		haxe.Log.trace(s,{ fileName : "HtmlHelper.hx", lineNumber : 390, className : "core.HtmlHelper", methodName : "toPopupImageHtml"});
	} else {
		s = "";
